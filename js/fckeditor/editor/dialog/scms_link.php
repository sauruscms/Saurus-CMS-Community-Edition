...
<html>
	<head>
		...
		<script src="scms_link/fck_link.js" type="text/javascript"></script>
	</head>
			...
			<div id="divLinkTypeUrl">
				<table cellspacing="0" cellpadding="0" width="100%" border="0" dir="ltr">
					...
					<tr>
						<td nowrap="nowrap">&nbsp;</td>
						<td colspan="2">
							<input type="checkbox" id="txtPopIt" onclick="togglePopIt(this.checked)"><label for="txtPopIt" fckLang="DlgSCMSPopIt">Open in new window</label>
						</td>
					</tr>
				</table>
				<br />
