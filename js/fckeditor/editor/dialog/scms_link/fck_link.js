...
window.onload = function()
{
	...
	if(GetE('cmbTarget').value == '_blank')
	{
		GetE('txtPopIt').checked = true;
	}
}
...
function SetTarget( targetType )
{
	...
	/* PopIt checkbox */
	if(GetE('cmbTarget').value != '_blank') GetE('txtPopIt').checked = false;
	if(GetE('cmbTarget').value == '_blank') GetE('txtPopIt').checked = true;
}
...
/* SCMS usability PopIt toggler */
function togglePopIt(checked)
{
	if(checked)	
	{
