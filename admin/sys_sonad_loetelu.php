	...
	<div id="scms_content_body">
		...
		<div id="glossary_words_container">
			...
			foreach($words as $mysona)
			{
				...
				# bold: tee s�na, mida kasutatakse bold-iks
				# kui t�lge on erinev kui t�lge tootes, siis tee t�lge bold-iks
				if(trim($mysona[sona]) != trim($mysona[origin_sona])) { $bold = 1;}
				# kui t�lge puudub �ldse (t�histring), siis tee t�lge tootes bold-iks
